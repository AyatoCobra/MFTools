...
function main()
    ...
    sampAddChatMessage("{3498DB}[MFTools v1.0 (beta test)] {FFFFFF}Ñêðèïò óñïåøíî çàãðóæåí! Ìåíþ: {FFDD00}/mft", -1)
    ...
    sampRegisterChatCommand("mft_up", function() 
        if updateAvailable then
            ...
            lua_thread.create(function()
                -- 1. Ñêà÷èâàåì ãëàâíûé ôàéë MFTools.lua
                ...
                -- 2. Ïðèíóäèòåëüíî ñêà÷èâàåì è ïåðåçàïèñûâàåì ÂÑÅ çàâèñèìûå ôàéëû
                ...
                -- 3. Æäåì, ïîêà ñ÷åò÷èê ñêà÷àííûõ ôàéëîâ íå ñðàâíÿåòñÿ ñ îáùèì êîëè÷åñòâîì è íå ñêà÷àåòñÿ ÿäðî
                while downloaded < totalFiles or not mainScriptDownloaded do wait(100) end
                
                -- 4. Ïåðåçàãðóæàåì ñêðèïò òîëüêî êîãäà âñ¸ 100% ñêà÷àëîñü
